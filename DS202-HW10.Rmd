...
dim(persons1)-dim(acc)
#added  69 columns, and 17475 rows
...
# Radar plot the days of the week?
# Maybe plot them on a map?
# other cool ideas?
# Do a cool multi graph comparing men and women drunk drivers
# Do a weird day of the week, colored by hour data
```